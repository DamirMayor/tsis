...
data = json.loads(aa_json)

print("Interface Status")
print("="*80)
print("DN" + "\t"*4 + "x." + "\t"*3 + "Description" + "\t" + "Speed" + "\t"*2 + "MTU")
print("-"*50 + " " + "-"*20 + " " + "-"*6 + "\t"*2 + "-" * 6)
for item in data["imdata"]:
  if item["l1PhysIf"]["attributes"]["speed"] == "inherit" and item["l1PhysIf"]["attributes"]["mtu"] == "9150":
    print(item["l1PhysIf"]["attributes"]["dn"] + "\t"*4 + item["l1PhysIf"]["attributes"]["speed"] + "\t"*2 + item["l1PhysIf"]["attributes"]["mtu"])
